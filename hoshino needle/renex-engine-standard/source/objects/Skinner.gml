...
if (vineL!=noone) {
    with (WallJumpL) {sprite_index=other.vineL image_blend=other.blend image_alpha=other.alpha}
}
if (vineR!=noone) {
    with (WallJumpR) {sprite_index=other.vineR image_blend=other.blend image_alpha=other.alpha}
}
if (pform!=noone) {
    with (Platform) {sprite_index=other.pform image_blend=other.blend image_alpha=other.alpha}
}
